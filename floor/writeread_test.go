...
func TestWriteRead(t *testing.T) {
	...
	t.Run("int64 parquet type", func(t *testing.T) {
	...
	t.Run("int32 parquet type", func(t *testing.T) {
		t.Run("int go type", func(t *testing.T) {
			o := struct{ Val int }{Val: 1}
	...
	t.Run("byte_array parquet types", func(t *testing.T) {
	...
	t.Run("float parquet type", func(t *testing.T) {
	...
	t.Run("double parquet type", func(t *testing.T) {
	...
	t.Run("boolean parquet type", func(t *testing.T) {
