...
func TestOneColumn(t *testing.T) {
	...
	assert.Equal(t, []interface{}{int32(10), int32(20)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{0, 0}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 0}, d.data.currRLevels.toArray())
...
func TestOneColumnOptional(t *testing.T) {
	...
	assert.Equal(t, uint16(0), d.MaxRepetitionLevel())
	assert.Equal(t, []interface{}{int32(10)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{1, 0}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 0}, d.data.currRLevels.toArray())
...
func TestOneColumnRepeated(t *testing.T) {
	...
	assert.Equal(t, []interface{}{int32(10), int32(20)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{1, 1, 0}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 1, 0}, d.data.currRLevels.toArray())
...
func TestComplexPart1(t *testing.T) {
	...
	assert.Equal(t, []interface{}{int32(1), int32(2), int32(3)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{2, 2, 1, 2}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 2, 1, 1}, d.data.currRLevels.toArray())

	d, err = row.findDataColumn("Name.Language.Country")
	require.NoError(t, err)
	assert.Equal(t, uint16(3), d.MaxDefinitionLevel())
	assert.Equal(t, uint16(2), d.MaxRepetitionLevel())
	assert.Equal(t, []interface{}{int32(100), int32(101)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{3, 2, 1, 3}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 2, 1, 1}, d.data.currRLevels.toArray())
	...
	assert.Equal(t, uint16(2), d.MaxDefinitionLevel())
	assert.Equal(t, uint16(1), d.MaxRepetitionLevel())
	assert.Equal(t, []interface{}{int32(10), int32(11)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{2, 2, 1}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 1, 1}, d.data.currRLevels.toArray())
...
func TestComplexPart2(t *testing.T) {
	...
	assert.Equal(t, uint16(2), d.MaxDefinitionLevel())
	assert.Equal(t, uint16(1), d.MaxRepetitionLevel())
	assert.Equal(t, []interface{}{int32(20), int32(40), int32(60), int32(80)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{2, 2, 2, 2}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 1, 1, 0}, d.data.currRLevels.toArray())

	d, err = row.findDataColumn("Links.Backward")
	require.NoError(t, err)
	assert.Equal(t, uint16(2), d.MaxDefinitionLevel())
	assert.Equal(t, uint16(1), d.MaxRepetitionLevel())
	assert.Equal(t, []interface{}{int32(10), int32(30)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{1, 2, 2}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 0, 1}, d.data.currRLevels.toArray())
...
func TestComplex(t *testing.T) {
	...
	assert.Equal(t, uint16(2), d.MaxDefinitionLevel())
	assert.Equal(t, uint16(1), d.MaxRepetitionLevel())
	assert.Equal(t, []interface{}{int32(10), int32(11), int32(12)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{2, 2, 1, 2}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 1, 1, 0}, d.data.currRLevels.toArray())
	...
	assert.Equal(t, uint16(2), d.MaxRepetitionLevel())
	assert.Equal(t, []interface{}{int32(100), int32(101)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{3, 2, 1, 3, 1}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 2, 1, 1, 0}, d.data.currRLevels.toArray())
	...
	assert.Equal(t, uint16(2), d.MaxRepetitionLevel())
	assert.Equal(t, []interface{}{int32(1), int32(2), int32(3)}, d.data.currValues.assemble())
	assert.Equal(t, []int32{2, 2, 1, 2, 1}, d.data.currDLevels.toArray())
	assert.Equal(t, []int32{0, 2, 1, 1, 0}, d.data.currRLevels.toArray())
...
func TestTwitterBlog(t *testing.T) {
	...
	assert.Equal(t, expected, d.data.currValues.assemble())
	assert.Equal(t, uint16(2), d.MaxDefinitionLevel())
	assert.Equal(t, uint16(2), d.MaxRepetitionLevel())
	assert.Equal(t, []int32{0, 2, 2, 1, 2, 2, 2, 0, 1, 2}, d.data.currRLevels.toArray())
	assert.Equal(t, []int32{2, 2, 2, 2, 2, 2, 2, 2, 2, 2}, d.data.currDLevels.toArray())
...
func TestEmptyParent(t *testing.T) {
	...
	assert.Equal(t, []interface{}{}, col.data.currValues.assemble())

	assert.Equal(t, uint16(2), col.MaxDefinitionLevel())
	assert.Equal(t, uint16(1), col.MaxRepetitionLevel())
	require.Equal(t, []int32{0}, col.data.currRLevels.toArray())
	require.Equal(t, []int32{1}, col.data.currDLevels.toArray())
...
func TestZeroRL(t *testing.T) {
	...
	assert.Equal(t, uint16(1), d.MaxDefinitionLevel())
	assert.Equal(t, uint16(1), d.MaxRepetitionLevel())
	assert.Equal(t, []int32{0, 1}, d.data.currRLevels.toArray())
	assert.Equal(t, []int32{1, 1}, d.data.currDLevels.toArray())
