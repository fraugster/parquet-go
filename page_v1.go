...
func (dp *dataPageReaderV1) readValues(size int) (values []any, dLevel *packedArray, rLevel *packedArray, err error) {
...
func newDataPageV1Writer(useDict bool, dictValues []any, page *dataPage, enableCRC bool) pageWriter {
